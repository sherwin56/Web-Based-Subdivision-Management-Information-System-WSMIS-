                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Age</th>
                                                <th>Gender</th>
                                                <th>House & Land Ownership Status</th>
                                        ...
                                        <tbody>
                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                $squery = mysqli_query($con, "SELECT zone,id,CONCAT(lname, ', ', fname, ' ', mname) as cname, age, gender, landOwnershipStatus, image FROM tblresident order by zone");
                                                ...
                                                $squery = mysqli_query($con, "SELECT zone,id,CONCAT(lname, ', ', fname, ' ', mname) as cname, age, gender, houseOwnershipStatus, image FROM tblresident order by zone");
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    echo '
                                                    <tr>
