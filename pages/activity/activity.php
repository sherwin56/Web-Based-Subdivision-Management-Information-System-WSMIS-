                                ...
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        ?>
                                                ...
                                                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Announcement</button>  
                                                ...
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-info btn-sm" data-target="#view_modal'.$row['id'].'" data-toggle="modal"><i class="fa fa-search" aria-hidden="true"></i> Photo</button>
                                                        </td>
                                                    </tr>
                                                    ';
                                            ...
                                            elseif(isset($_SESSION['resident'])){
                                                ...
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>'.$row['description'].'</td> 
                                                        <td>
                                                            <button class="btn btn-info btn-sm" data-target="#view-modal'.$row['id'].'" data-toggle="modal"><i class="fa fa-search" aria-hidden="true"></i> View</button>
                                                        </td>  
                                                    </tr>
                                                    ';
