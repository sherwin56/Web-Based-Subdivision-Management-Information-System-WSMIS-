<!-- ========================= MODAL ======================= -->
<div id="disapprovesolicitModal<?php echo $row['s_id']?>" class="modal fade">
            <form method="post">
              <div class="modal-dialog modal-sm" style="width:300px !important;">
                ...
                <input type="hidden" value="'.$row['s_id'].'" name="hidden_idsolicit" id="hidden_idsolicit"/>';
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary btn-sm" name="btnsolicitdisapprove" value="Disapprove"/>
                    </div>
                </div>
              </div>
              </form>
