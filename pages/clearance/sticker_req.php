                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addadminsticker"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Car Sticker</button>
                                            ...
                                            <tbody>
                                                ...
                                                if(!isset($_SESSION['staff']))
                                                {
                                                    ...
                                                    while($row = mysqli_fetch_array($squery))
                                                    {
                                                        echo '
                                                        <tr>
                                                            <td><input type="checkbox" name="chk_deleteid[]" class="chk_deleteid" value="'.$row['cid'].'" /></td>
                                                            <td>'.$row['residentname'].'</td>
                                                            <td>'.$row['req_type'].'</td>
                                                            <td>'.$row['status'].'</td>
                                                        </tr>
