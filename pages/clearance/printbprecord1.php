...
<style>
    ...
    {
    ob_start();
    $_SESSION['clr'] = $_GET['buildingrecord1'];
    ...
    <body class="skin-black" >
       ...
       <div>
                <div style="background: white; padding-right: 10px; padding-left: 10px;">
                    ...
                    <tbody>
                    <?php
                    $squery = mysqli_query($con, "SELECT *,CONCAT(r.lname, ', ' ,r.fname, ' ' ,r.mname) as residentname,p.id as pid from tblresident r left join tblbuilding p on p.residentid = r.id where residentid = '".$_GET['resident']."' and permit_no = '".$_GET['buildingrecord1']."' ");
