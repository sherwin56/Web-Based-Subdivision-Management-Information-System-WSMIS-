...
<style>
    ...
    {
    ob_start();
    $_SESSION['clr'] = $_GET['solicitrecord2'];
    ...
    <body class="skin-black" >
       ...
       <div>
                <div style="background: white; padding-right: 10px; padding-left: 10px;">
                    ...
                    <tbody>
                    <?php
                    $squery = mysqli_query($con, "SELECT * from tblsolicit where residentid = '".$_GET['resident']."' and solicit_no = '".$_GET['solicitrecord2']."' ");
