...
<style>
    ...
    {
    ob_start();
    $_SESSION['clr'] = $_GET['reserverecord2'];
    ...
    <body class="skin-black" >
       ...
       <div>
                <div style="background: white; padding-right: 10px; padding-left: 10px;">
                    ...
                    <tbody>
                    <?php
                    $squery = mysqli_query($con, "SELECT * FROM tblreserve where residentid = '".$_GET['resident']."' and reserve_no = '".$_GET['reserverecord2']."' ");
