...
<style>
    ...
    {
    ob_start();
    $_SESSION['clr'] = $_GET['stickerrecord'];
    ...
    <body class="skin-black" >
       ...
       <div>
                <div style="background: white; padding-right: 10px; padding-left: 10px;">
                    ...
                    <tbody>
                    <?php
                    $squery = mysqli_query($con, "SELECT *,CONCAT(rc.lname, ', ' ,rc.fname, ' ' ,rc.mname) as residentname from tblresident rc left join tblsticker c on c.residentid = rc.id where residentid = '".$_GET['resident']."' and sticker_no = '".$_GET['stickerrecord']."' ");
