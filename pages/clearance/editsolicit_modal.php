  ...
  <div class="modal-dialog modal-sm" style="width:300px !important;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Edit Solicitation</h4>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control input-sm" type="text" value="'.$row['fname'].'" readonly/>
                </div>
                <div class="form-group">
                    <label>Date: </label>
                    <input name="editdatesol" class="form-control input-sm" type="date" value="'.$row['date'].'" required/>
                </div>
                <div class="form-group">
                    <label>Amount : </label>
