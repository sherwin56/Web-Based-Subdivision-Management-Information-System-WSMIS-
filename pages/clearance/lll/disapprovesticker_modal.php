<!-- ========================= MODAL ======================= -->
<div id="disapprovestickerModal<?php echo $row['cid']?>" class="modal fade">
            <form method="post">
              <div class="modal-dialog modal-sm" style="width:300px !important;">
                ...
                <input type="hidden" value="'.$row['cid'].'" name="hidden_stickerid" id="hidden_stickerid"/>';
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary btn-sm" name="btn_disapprovesticker" value="Disapprove"/>
                    </div>
                </div>
              </div>
              </form>
