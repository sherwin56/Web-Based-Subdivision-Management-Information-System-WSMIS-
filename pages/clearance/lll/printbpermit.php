                    ...
                    <div class="col-xs-12 col-md-12">
                        <?php
                            ...
                            while($row = mysqli_fetch_array($qry4)){
                                echo '
                                <p class="text-center" style="font-size: 21px; font-size:bold; font-family: arial; font-stretch: condensed; line-height: 1.1;">OFFICE OF THE BUILDING INSPECTOR<br><b style="font-size: 30px; font-family: arial; font-stretch: condensed;">BUILDING PERMIT</b></p>
