                                        ...
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                if(!isset($_SESSION['staff']))
                                                {
                                                    ...
                                                    $squery2 = mysqli_query($con, "SELECT *,CONCAT(rs.lname, ', ' ,rs.fname, ' ' ,rs.mname) as residentname,s.id as s_id FROM tblsolicit s left join tblresident rs on rs.id = s.residentid  where status = 'Approved'") or die('Error: ' . mysqli_error($con));
