                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#adminbuildingp"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Construction Bond</button>
                                                ...
                                                if(!isset($_SESSION['staff']))
                                                {
                                                    ...
                                                    while($row = mysqli_fetch_array($squery))
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>₱'.$row['amount'].'</td>
                                                            <td> '.$row['status'].'</td>
                                                            <td><button class="btn btn-primary btn-sm" data-target="#editModal'.$row['pid'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true" onclick="location.reload();"></i> Edit</button>
                                                    ...
                                                    $squery = mysqli_query($con, "SELECT *, p.id as pid FROM tblbuilding p where status = 'Approved' and p.residentid = '0'") or die('Error: ' . mysqli_error($con));
                                                        while($row = mysqli_fetch_array($squery))
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <a href="printadminbpermit.php?resident='.$row['residentid'].'&adminbuilding='.$row['permit_no'].'&val='.base64_encode($row['permit_no'].'|'.$row['ownername'].'|'.$row['date']).'" onclick="location.reload();" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Print</a></td>
                                                            </tr>
                                                            ';
                                ...
                                <?php include "buildingpermit.php"; ?>
                            </div><!-- /.box -->
