...
<style>
    ...
    {
    ob_start();
    $_SESSION['clr'] = $_GET['adminsolicit'];
    ...
    <body class="skin-black" >
       ...
       <div class="col-xs-12 col-sm-6 col-md-6" style="background: white; padding-top: 20px;padding-right: 50px;padding-bottom: 20px;padding-left: 50px;">
            <div>
                ...
                <div style="background: white;">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <p class="text-center" style="font-size: 50px;"><b>SOLICITATION</b></p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12" style="float:left; margin-top: 10px; font-size: 18px;">
                    <?php $qry=mysqli_query($con,"SELECT * from tblsolicit where residentid = '".$_GET['resident']."' and solicit_no = '".$_GET['adminsolicit']."' ");                  
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12" style="font-size: 18px;">
                        <?php
                            $qry3=mysqli_query($con,"SELECT * from tblsolicit where residentid = '".$_GET['resident']."' and solicit_no = '".$_GET['adminsolicit']."' ");
