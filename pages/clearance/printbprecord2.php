...
<style>
    ...
    {
    ob_start();
    $_SESSION['clr'] = $_GET['buildingrecord2'];
    ...
    <body class="skin-black" >
       ...
       <div>
                <div style="background: white; padding-right: 10px; padding-left: 10px;">
                    ...
                    <tbody>
                    <?php
                    $squery = mysqli_query($con, "SELECT * from tblbuilding where residentid = '".$_GET['resident']."' and permit_no = '".$_GET['buildingrecord2']."' ");
