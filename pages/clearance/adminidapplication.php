...
<div id="adminid" class="modal fade">
<form method="post">
              <div class="modal-dialog modal-sm" style="width:300px !important;">
                <div class="modal-content">
                            ...
                            <div class="col-md-12">
                                ...
                                <label for="payment">
                                        ...
                                        <div id="hiddenpaymentadmin" class="hideadmin">
                                            <input name="txtadminidref" id="txtadminidref"class="form-control input-sm" type="number" placeholder="Reference Number" value=0/>
                                        </div>
                                </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary btn-sm" name="btn_addadminid" value="Add ID Application"/>
                    </div>
                </div>
              </div>
              </form>
