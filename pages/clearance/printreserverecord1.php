<!DOCTYPE html>
<html id="reserverecord1">
    <title>Clubhouse Reservation Record</title>
<style>
    @media print {
        .noprint {
        visibility: hidden;
    ...
    {
    ob_start();
    $_SESSION['clr'] = $_GET['reserverecord1'];
    ...
    <body class="skin-black" >
       ...
       <div>
                <div style="background: white; padding-right: 10px; padding-left: 10px;">
                    ...
                    <tbody>
                    <?php
                    $squery = mysqli_query($con, "SELECT *,CONCAT(rr.lname, ', ' ,rr.fname, ' ' ,rr.mname) as residentname,cr.id as crid FROM tblreserve cr left join tblresident rr on rr.id = cr.residentid  where residentid = '".$_GET['resident']."' and reserve_no = '".$_GET['reserverecord1']."' ");
