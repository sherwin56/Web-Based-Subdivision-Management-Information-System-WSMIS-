...
<style>
    ...
    {
    ob_start();
    $_SESSION['clr'] = $_GET['solicitrecord1'];
    ...
    <body class="skin-black" >
       ...
       <div>
                <div style="background: white; padding-right: 10px; padding-left: 10px;">
                    ...
                    <tbody>
                    <?php
                    $squery = mysqli_query($con, "SELECT *,CONCAT(rs.lname, ', ' ,rs.fname, ' ' ,rs.mname) as residentname from tblresident rs left join tblsolicit s on s.residentid = rs.id where residentid = '".$_GET['resident']."' and solicit_no = '".$_GET['solicitrecord1']."' ");
