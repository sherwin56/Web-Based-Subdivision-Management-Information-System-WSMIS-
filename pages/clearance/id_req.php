                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#adminid"><i class="fa fa-user-plus" aria-hidden="true"></i> Add ID Application</button>
                                ...
                                <?php include "adminidapplication.php"; ?>
                            </div><!-- /.box -->
