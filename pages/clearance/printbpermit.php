...
<style>
    ...
    <body class="skin-black" >
        ...
        <div class="col-xs-12 col-sm-6 col-md-5" style="background: white;" >
            <div style="">
                <div class="col-xs-4 col-sm-6 col-md-3" style="background: white; padding-top: 10px; margin-right:10px; border: 2px solid black;">
                    <center><image src="../../img/sanmarino.png" style="width:90%;height:164px;"/></center>
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">
                    <div style="font-size: 20px; algin-items: center; justify-content: center; font-family: arial; font-stretch: condensed;"><b>
                    ...
                    <div class="pull-left" style="float:left; margin-top: 10px; font-size: 15px;">
                        <?php $qry2=mysqli_query($con,"SELECT * from tblresident r left join tblbuilding b on b.residentid = r.id where residentid = '".$_GET['resident']."' and permit_no = '".$_GET['building']."' ");
                            while($row2 = mysqli_fetch_array($qry2)){
                                echo '<p>Permit No.:<u>'.$row2['permit_no'].'</u></p>';
                            }
                        ?>
                    </div>
                    <div class="pull-right" style="float:right ;margin-top: 10px; font-size: 15px;">
                       <?php $qry1=mysqli_query($con,"SELECT * from tblresident r left join tblbuilding b on b.residentid = r.id where residentid = '".$_GET['resident']."' and permit_no = '".$_GET['building']."' ");
                    ...
                    <div class="col-xs-12 col-md-12">
                        <?php
                            $qry4=mysqli_query($con,"SELECT *,CONCAT(r.lname, ', ' ,r.fname, ' ' ,r.mname) as residentname,p.id as pid from tblresident r left join tblbuilding p on p.residentid = r.id where residentid = '".$_GET['resident']."' and permit_no = '".$_GET['building']."' ");
                            while($row = mysqli_fetch_array($qry4)){
                                echo '
                                <p class="text-center" style="font-size: 21px; font-size:bold; font-family: arial; font-stretch: condensed; line-height: 1.1;">OFFICE OF THE BUILDING INSPECTOR<br><b style="font-size: 30px; font-family: arial; font-stretch: condensed;">CONSTRUCTION BOND</b></p>
                                <p style="text-indent:40px;text-align: justify;">
                                This permit certifies that <u>'.strtoupper($row['residentname']).'</u> has permission to build a <u>'.strtoupper($row['projecttype']).'</u> located on <u>'.strtoupper($row['address']).'</u> provided that the person accepting this permit shall conform to the term of the application 
                                ...
                                <p style="font-size: 16px; text-align: center; font-family: arial; font-stretch: condensed;">
