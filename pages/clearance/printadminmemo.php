...
<style>
    ...
    <body class="skin-black" >
       ...
       <div class="col-xs-12 col-sm-6 col-md-6" style="background: white; padding-left: 10px; padding-right: 10px;">
            <div>
                ...
                <div style="background: white;">
                    ...
                    <?php 
                        $qry=mysqli_query($con,"SELECT *from tblmemo where residentid = '".$_GET['resident']."' and memo_id = '".$_GET['adminmemo']."' ");
                        ...
                        $qry=mysqli_query($con,"SELECT *from tblmemo where residentid = '".$_GET['resident']."' and memo_id = '".$_GET['adminmemo']."' ");
                            while($row = mysqli_fetch_array($qry)){
                                ...
                                echo '
                                    ...
                                    <p style="margin-top: 20px;"><b style="text-transform: uppercase;">'.$row['fname'].'</b> ("Party B"), an individual with their main address 
                                    ...
                                    <p style="text-transform: uppercase;"><b>'.$row['address'].'</b></p>
                                    ';
                            }
                        ?>    
                    </div>
                    ...
                    <div class="col-xs-4 col-sm-6 col-md-9" style="margin-top: 10px; font-size: 14px; width: 80%;">
                        ...
                        $qry=mysqli_query($con,"SELECT *from tblmemo where residentid = '".$_GET['resident']."' and memo_id = '".$_GET['adminmemo']."' ");
                            while($row = mysqli_fetch_array($qry)){
                                ...
                                echo '
                                    <p><b>PURPOSE</b></p><br>
                                    <p>The purpose of this MIA is to establish the terms and conditions under which Part A and Part B will collaborate on a '.$row['subject'].'.</p>
