    ...
    <body class="skin-black" >
       ...
       <div>
                <div style="background: white; padding-right: 10px; padding-left: 10px;">
                    ...
                    <tbody>
                    <?php
                    $squery = mysqli_query($con, "SELECT *,CONCAT(ri.lname, ', ' ,ri.fname, ' ' ,ri.mname) as residentname from tblresident ri left join tblid i on i.residentid = ri.id where residentid = '".$_GET['resident']."' and id_no = '".$_GET['idrecord1']."' ");
